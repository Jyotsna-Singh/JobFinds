...
class JobsController extends AppController{
	...
	*/
	public function index(){ //View to be named after method.like index
		...
		$this->set('jobs', $jobs); //Setting a view-> name of controller object, variable
	}
	...
	*/
	public function browse($category = null){
		...
		$options = array(
			...
			$jobs = $this->Job->find('all', $options);
		//Set Title
		$this->set('title_for_layout', 'JobFinds | Browse For Any Job');
